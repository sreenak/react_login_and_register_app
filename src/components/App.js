        ...
        <div className="container-fluid main-conatiner">
          <Navbar>
            <Navbar.Brand className="brand1">
              <Link to="/">
                <Button className="border-btn">Jobsenlist</Button>
              </Link>
            </Navbar.Brand>
            <Navbar.Toggle />
            <Navbar.Collapse className="justify-content-end">
              <Navbar.Text className="brand2">
                <Link to="/login">
                  <Button className="border-btn mr-3">Signin </Button>
                </Link>
                <Link to="/signup">
                  <Button className="border-btn "> Signup</Button>
                </Link>
              </Navbar.Text>
            </Navbar.Collapse>
          </Navbar>
          <Switch>
            ...
            <Route path="/dashboard" type="private">
              <Dashboard />
            </Route>
          </Switch>
